...
\draw[->, bend right=15] (C) to node[labelstyle, below] {1, 4} (H);
\draw[->, bend right=15] (H) to node[labelstyle, above] {4, 7} (C);
\draw[->, bend right=15] (B) to node[labelstyle, above] {3, 6} (H);
\draw[->, bend right=15] (H) to node[labelstyle, above] {2, 5} (B);
\draw[->, bend right=15] (B) to node[labelstyle, below] {3, 6} (G);
\draw[->, bend right=15] (G) to node[labelstyle, above] {2, 5} (B);
\draw[->, bend right=15] (W) to node[labelstyle, above] {1, 4} (G);
\draw[->, bend right=15] (G) to node[labelstyle, above] {4, 7} (W);
\draw[->, bend right=15] (B) to node[labelstyle, above] {1, 4, 7} (P);
\draw[->, bend right=15] (P) to node[labelstyle, left] {2, 5, 8} (B);
\draw[->, bend right=15] (G) to node[labelstyle, right] {1, 4, 7} (P);
\draw[->, bend right=15] (P) to node[labelstyle, below] {2, 5, 8} (G);
\draw[->, bend right=15] (H) to node[labelstyle] {1, 4, 7} (M);
\draw[->, bend right=15] (M) to node[labelstyle] {2, 5, 8} (H);
\draw[->, bend right=15] (W) to node[labelstyle] {1, 4, 7} (M);
\draw[->, bend right=15] (M) to node[labelstyle] {2, 5, 8} (W);
\end{tikzpicture}
\end{frame}

\againframe{potsdam_map}
\againframe{potsdam_city_graph}
...
\begin{frame}{The infection process}
  \centering
  \includegraphics[width=0.6\linewidth]{media/infection_process_a.png} 

  \includegraphics[width=0.6\linewidth]{media/infection_process_b.png} \\
  \cite{Lee_2012}
\end{frame}
